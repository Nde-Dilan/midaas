    ...
    <div className="p-6 bg-background min-h-screen max-w-7xl mx-auto">
      ...
      <div className="bg-white border border-border rounded-2xl p-6 shadow-sm mb-6">
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          {/* Cover image */}
          <div className="w-full lg:w-1/3 aspect-[4/3] bg-gradient-to-br from-[#50E3C2]/5 to-[#50E3C2]/20 rounded-xl relative flex items-center justify-center overflow-hidden border border-slate-100">
          ...
          <div className="flex-1 space-y-4 w-full">
            ...
            <div className="flex items-center gap-4 pt-2">
              <Button
                ...
                disabled={!canInvest}
                className="bg-[#50E3C2] hover:bg-[#00c800] text-white px-8 py-6 text-base font-MontserratSemiBold rounded-xl disabled:opacity-40 disabled:cursor-not-allowed"
              >
                {canInvest
                  ? "Invest Now"
                  : project.status === "funded"
          ...
          {TABS.map(({ key, label }) => (
            <button
              ...
              className={`pb-3 text-sm font-medium tracking-wider border-b-2 transition-all whitespace-nowrap ${
                activeTab === key
                  ? "border-[#50E3C2] text-foreground font-MontserratSemiBold"
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="col-span-4 flex items-center gap-2">
                          <div className="w-7 h-7 rounded-full bg-[#50E3C2]/10 flex items-center justify-center text-[10px] font-MontserratSemiBold text-[#50E3C2] shrink-0">
      ...
      {canInvest && !isEntrepreneur && (
        <div className="fixed bottom-0 left-0 right-0 lg:hidden bg-white border-t border-border p-4 shadow-lg z-40">
          <Button
            onClick={handleInvest}
            className="w-full bg-[#50E3C2] hover:bg-[#00c800] text-white py-6 text-base font-MontserratSemiBold rounded-xl"
          >
