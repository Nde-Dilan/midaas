          ...
          {filteredProjects.map((project) => {
            ...
            return (
              <div
                ...
                className="group bg-white border border-border rounded-xl overflow-hidden shadow-sm hover:shadow-md hover:border-[#00de00]/30 transition-all cursor-pointer flex flex-col"
              >
                {/* Cover image placeholder */}
                <div className="h-36 bg-gradient-to-br from-[#00de00]/5 to-[#00de00]/20 relative flex items-center justify-center">
                ...
                <div className="p-5 flex-1 flex flex-col">
                  <h3 className="font-MontserratSemiBold text-sm text-foreground group-hover:text-[#00de00] transition-colors line-clamp-1 mb-1">
                    {project.title}
                  </h3>
                  {project.company && (
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                    ...
                    <span className="text-[11px] font-MontserratSemiBold text-[#00de00] flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      View details
                      <svg
                        width="12"
                        height="12"
                  ...
                  >
                    <TableCell className="pl-6">
                      <div className="flex flex-col">
                        <span className="font-MontserratSemiBold text-sm text-foreground group-hover:text-[#00de00] transition-colors line-clamp-1">
                          {project.title}
                        </span>
                      </div>
                    </TableCell>
