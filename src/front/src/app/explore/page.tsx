        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center gap-8">
              ...
              <Link
                href="/explore"
                className="text-sm text-[#50E3C2] font-MontserratSemiBold"
              >
                Explore Projects
              </Link>
            </nav>
      ...
      <section className="pt-32 pb-12 md:pt-40 md:pb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-MontserratBold text-gray-900 tracking-tight">
            Explore <span className="text-[#50E3C2]">Approved Projects</span>
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative max-w-xl mx-auto mb-6">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 text-sm border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:border-[#50E3C2] focus:ring-2 focus:ring-[#50E3C2]/10 outline-none transition-all"
            />
          </div>
              ...
              {CATEGORIES.map((s) => (
                <button
                  ...
                  className={twMerge(
                    ...
                    sectorFilter === s
                      ? "bg-[#50E3C2] text-white border-[#50E3C2]"
                      : "bg-white text-gray-600 border-gray-200 hover:border-[#50E3C2] hover:text-[#50E3C2]",
                  )}
                >
                  {s}
                </button>
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    {filtered.map((project) => {
                      ...
                      return (
                        <div
                          key={project.id}
                          className="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md hover:border-[#50E3C2]/20 transition-all duration-300 p-6 flex flex-col"
                        >
                          {/* Project title */}
                          ...
                          <Link
                            href="/auth/signup"
                            className="mt-4 w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 text-xs font-MontserratSemiBold text-white bg-[#50E3C2] rounded-xl hover:bg-[#00c800] transition-colors opacity-0 group-hover:opacity-100 focus:opacity-100"
                          >
                            Sign Up to Invest
                            <svg
                              width="14"
      ...
      <section className="py-16 bg-gray-50/50 border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mt-6 flex items-center justify-center gap-4">
            <Link
              href="/auth/signup"
              className="inline-flex items-center gap-2 px-8 py-3 text-sm font-MontserratSemiBold text-white bg-[#50E3C2] rounded-full hover:bg-[#00c800] transition-colors shadow-lg shadow-[#50E3C2]/25"
            >
              Create Free Account
            </Link>
            <Link
              href="/auth/signin"
              className="inline-flex items-center gap-2 px-8 py-3 text-sm font-MontserratSemiBold text-gray-700 border border-gray-200 rounded-full hover:border-[#50E3C2] hover:text-[#50E3C2] transition-colors"
            >
              Sign In
            </Link>
          </div>
