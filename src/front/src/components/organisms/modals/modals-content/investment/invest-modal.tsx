    ...
    <div className="w-full max-w-md mx-auto bg-white p-6 rounded-2xl">
      ...
      {step === "form" && (
        <div className="space-y-5">
          ...
          <div className="text-center">
            <div className="w-12 h-12 mx-auto mb-3 rounded-full bg-[#50E3C2]/10 flex items-center justify-center">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
          ...
          <div>
                ...
                <button
                  ...
                  className={`px-3 py-2 text-xs font-MontserratSemiBold rounded-lg border transition-all ${
                    parseInt(amount) === preset
                      ? "border-[#50E3C2] bg-[#50E3C2]/10 text-[#50E3C2]"
                      : "border-gray-200 text-gray-600 hover:border-[#50E3C2] hover:text-[#50E3C2]"
                  }`}
                >
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-14 pr-4 py-3 text-sm border border-gray-200 rounded-xl focus:border-[#50E3C2] focus:ring-2 focus:ring-[#50E3C2]/10 outline-none transition-all"
              />
            </div>
            {amount && (
              <div className="mt-2 space-y-1 text-xs text-gray-500">
                ...
                <div className="flex justify-between text-[#50E3C2] font-medium">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 text-sm border border-gray-200 rounded-xl focus:border-[#50E3C2] focus:ring-2 focus:ring-[#50E3C2]/10 outline-none transition-all"
              />
              {detectedCountry && (
          ...
          <div>
            ...
            {providersLoading ? (
              ...
              <select
                ...
                className="w-full px-4 py-3 text-sm border border-gray-200 rounded-xl focus:border-[#50E3C2] focus:ring-2 focus:ring-[#50E3C2]/10 outline-none transition-all bg-white appearance-none"
              >
          ...
          <div className="flex gap-3 pt-2">
            ...
            <Button
              ...
              disabled={!isValid}
              className="flex-1 bg-[#50E3C2] hover:bg-[#00c800] text-white disabled:opacity-40"
            >
              Invest Now
            </Button>
          </div>
      ...
      {step === "confirming" && (
        <div className="py-10 text-center space-y-4">
          <Loader className="w-10 h-10 animate-spin mx-auto text-[#50E3C2]" />
      ...
      {step === "success" && result && (
        <div className="py-6 text-center space-y-4">
          ...
          <div className="bg-gray-50 rounded-xl p-4 space-y-2 text-sm text-left">
            ...
            <div className="flex justify-between text-[#50E3C2]">
          ...
          <Button
            onClick={handleClose}
            className="w-full bg-[#50E3C2] hover:bg-[#00c800] text-white"
          >
            Done
          </Button>
        </div>
        ...
        <div className="py-6 text-center space-y-4">
          ...
          <div className="flex gap-3">
            ...
            <Button
              ...
              className="flex-1 bg-[#50E3C2] hover:bg-[#00c800] text-white"
            >
              Try Again
            </Button>
          </div>
